...
import { hasValidationErrors, ToStrService } from '../Services';
...
export class AddCategoryComponent implements OnInit, OnDestroy {
  ...
  hasCategoryFormErrors(controlName: string): boolean {
    return hasValidationErrors(this.categoryForm, controlName);
  }
